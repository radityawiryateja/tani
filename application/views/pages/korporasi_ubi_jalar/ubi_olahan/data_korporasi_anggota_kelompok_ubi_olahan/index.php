        ...
        <div class="modal-content">
            ...
            <form id="form">
                <div class="modal-body">
					...
					<input type="hidden" class="d-none" name="id_korporasi_ubi_olahan" value="<?= $id_korporasi_ubi_olahan ?>">
					...
					<input type="hidden" class="d-none" name="id_kecamatan" id="id_kecamatan_hidden" value="<?= $korporasi_ubi_olahan->id_kecamatan ?>">
<!-- 
					<div class="mb-3">
					...
					<input type="hidden" class="d-none" name="id_desa" id="id_desa_hidden" value="<?= $korporasi_ubi_olahan->id_desa ?>">
...
<header class="mb-3">
    <div class="row">
        <div class="col-md-8">
            <h1 class="fw-bold">Daftar Anggota Kelompok <?= $korporasi_ubi_olahan->nama ?></h1>
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb p-0">
					...
					<li class="breadcrumb-item"><a href="<?= base_url('korporasi_ubi_jalar/ubi_olahan') ?>">Daftar Kelompok Ubi Olahan</a></li>
					<li class="breadcrumb-item active" aria-current="page">Anggota Kelompok Ubi Olahan <?= $korporasi_ubi_olahan->nama ?></li>
				</ol>
			</nav>
        </div>
        ...
        <div class="filters d-flex flex-md-row flex-column mb-4">
            <div class="d-flex flex-grow-1 justify-content-md-between me-md-3 mb-md-0 mb-3">
                ...
                <select class="form-select search-filter" name="search-by">
                    <option value="korporasi_anggota_ubi_olahan.nama">Nama</option>
					<option value="korporasi_anggota_ubi_olahan.sumber_bahan_baku">Sumber Bahan Baku</option>
					<option value="korporasi_anggota_ubi_olahan.pemasaran">Cara Pemasaran</option>
					<option value="korporasi_anggota_ubi_olahan.alamat">Alamat</option>
                </select>
            </div>
...
<script>
    const config = {
        baseURL: '<?= base_url() . 'korporasi_ubi_jalar/data_korporasi_anggota_kelompok_ubi_olahan/' ?>',
        table: {
		...
		$.get(requestURL, {
			...
			openModal({
				...
				onUpdateOpen: () => {
					...
					$('#id_korporasi_ubi_olahan').val(response.id_korporasi_ubi_olahan);
    ...
    const createNewData = () => {
        ...
        openModal({
            ...
            beforeModalShow: () => {
				...
				let id_kecamatan = '<?= $korporasi_ubi_olahan->id_kecamatan ?>';
				let id_desa = '<?= $korporasi_ubi_olahan->id_desa ?>';
