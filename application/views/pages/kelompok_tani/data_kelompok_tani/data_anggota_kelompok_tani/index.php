        ...
        <div class="modal-content">
            ...
            <form id="form">
                <div class="modal-body">
					...
					<input type="hidden" class="d-none" name="id_kel_tani" value="<?= $id_kel_tani ?>">

                    <div class="mb-3">
						<label for="nama_anggota" class="form-label">Nama <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="nama_anggota" name="nama_anggota" placeholder="Masukkan nama anggota kelompok tani" autofocus>
                    </div>
...
<!-- 
					...
					<div class="mb-3">
						<label for="luas_baku" class="form-label">Luas Baku</label>
						<input type="text" class="form-control" id="luas_baku" name="luas_baku" placeholder="Masukkan luas baku">
					</div>
...
<header class="mb-3">
    <div class="row">
        <div class="col-md-8">
            <h1 class="fw-bold">Daftar Anggota Kelompok <?= $kel_tani->nama ?></h1>
            <p>Pengelolaan data anggota kelompok tani</p>

			<!-- breadcrum -->
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb p-0">
					<li class="breadcrumb-item"><a href="<?= base_url() ?>">Beranda</a></li>
					<li class="breadcrumb-item"><a href="<?= base_url('kelompok_tani/data_kelompok_tani') ?>">Daftar Kelompok Tani</a></li>
					<li class="breadcrumb-item active" aria-current="page">Anggota Kelompok Tani <?= $kel_tani->nama ?></li>
				</ol>
			</nav>
        </div>
        ...
        <div class="filters d-flex flex-md-row flex-column mb-4">
            <div class="d-flex flex-grow-1 justify-content-md-between me-md-3 mb-md-0 mb-3">
                ...
                <select class="form-select search-filter" name="search-by">
                    <option value="anggota_kel_tani.nama">Nama</option>
					<option value="anggota_kel_tani.pemasaran">Cara Pemasaran</option>
					<option value="anggota_kel_tani.alamat">Alamat</option>
                </select>
            </div>
            ...
            <table class="table table-striped text-nowrap align-middle mb-0">
                <thead>
                    <tr>
						...
						<th scope="col" style="min-width: 100px" class="text-center align-middle">Luas Baku</th>
...
<script>
    const config = {
        baseURL: '<?= base_url() . 'kelompok_tani/data_anggota_kelompok_tani/' ?>',
        table: {
            name: 'tabelAnggotaKelompokTani',
            columnTotal: 9,
        },
        formConfig: {
        ...
        return data.map((val) => {
            ...
            return `
                <tr>
					...
					<td>${val.luas_baku ? val.luas_baku : '-'}</td>
...
<script>
    const editData = (requestURL, id) => {
		...
		$.get(requestURL, {
			...
			openModal({
				state: 'update',
				modalContext: 'Anggota Kelompok Tani',
				onUpdateOpen: () => {
					$('#pemasaran').select2({
					...
					$('#luas_baku').val(response.luas_baku);
