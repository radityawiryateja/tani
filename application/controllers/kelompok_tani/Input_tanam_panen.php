...
class Input_tanam_panen extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = [
            'view' => 'pages/kelompok_tani/data_tanam_panen/input_tanam_panen/index',
    ...
    public function load_table($row_no = 0)
	{
		...
		$config = [
			...
			'group_by' => [],
			'where' => $where,
			'base_url' => base_url() . 'kelompok_tani/data_tanam_panen/input_tanam_panen/index'
		];
